...
void tst_List_country(dbc* db){
    t_algo_meta cty_list = {NULL, 0, sizeof(ccty_recur), is_country_null, allocate_country, free_country, compare_country_name, swap_country, assign_country, NULL, NULL, country_right, country_left};
...
void tst_AVL_country(dbc* db){
    t_algo_meta cty_avl = {NULL, 0, sizeof(ccty_recur), is_country_null, allocate_country, free_country, compare_country_name, swap_country, assign_country, get_country_height, set_country_height, country_right, country_left};
    t_algo_meta cty_array = {db->cty+1, db->nr_cty, sizeof(ccty), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL};
